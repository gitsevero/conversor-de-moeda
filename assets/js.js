...
const getWeatherData = async (moeda, base, quantia) => {
    ...
    const apiWeatherURL = `https://api.fastforex.io/convert?from=${moeda}&to=${base}&amount=${quantia}&api_key=d70779afb8-93e0f0eaa4-rowtd3`;
...
const getCoin = async () => {
    const option = `https://api.fastforex.io/currencies?api_key=d70779afb8-93e0f0eaa4-rowtd3`
...
const showWeatherData = async (moeda, base, quantia) => {
    ...
    cotacao.innerHTML = entries[1][1].toFixed(3)
